                  ...
                  {equipment.map((item, index) => {
                    ...
                    <div
                      ...
                      className={`relative h-auto min-h-[280px] sm:h-72 md:h-80 lg:h-84 animate-fade-in ${
                        isOutOfStock ? 'cursor-not-allowed opacity-60' : 'cursor-pointer group'
                      }`}
                    ...
                    >
                      <div className={`relative bg-gradient-to-br from-white via-gray-50 to-blue-50 border-2 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 h-full flex flex-col justify-between items-center transition-all duration-500 ${
                        isOutOfStock 
                          ? 'border-gray-300 bg-gradient-to-br from-gray-100 to-gray-200'
                          : isRacketBooked(item.equipment_name) 
                            ? 'border-green-500 ring-4 ring-green-200 bg-gradient-to-br from-green-50 to-green-100 shadow-green-200 hover:shadow-2xl hover:scale-105 hover:-translate-y-2' 
                            : 'border-gray-200 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 group-hover:border-blue-400 group-hover:from-blue-50 group-hover:to-blue-100'
                      }`}>
                        {/* Premium Badge */}
                        {availableStock > 5 && (
                        ...
                        <div className="w-full text-center space-y-2 sm:space-y-3">
                          <h3 className={`font-bold text-xs sm:text-sm md:text-base lg:text-lg line-clamp-2 transition-all duration-300 px-1 ${
                            isOutOfStock 
                              ? 'text-gray-500' 
                              : 'text-gray-900 group-hover:text-blue-600 transform group-hover:scale-105'
                          }`}>
                            {item.equipment_name}
                          </h3>
                          ...
                          <div className="flex items-center justify-center space-x-1.5 sm:space-x-2">
                            ...
                            <p className={`text-[10px] sm:text-xs md:text-sm font-medium line-clamp-1 ${
                          ...
                          <div className={`rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2 border shadow-sm transition-all duration-300 ${
                            isOutOfStock
                              ? 'bg-gradient-to-r from-gray-100 to-gray-200 border-gray-300'
                              : 'bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200 group-hover:shadow-md'
                          }`}>
                            <p className={`text-xs sm:text-sm md:text-base font-bold ${
                              isOutOfStock ? 'text-gray-500' : 'text-blue-600 group-hover:text-blue-700'
                            }`}>
                              ₱{item.price}/hour
                            </p>
                          </div>
