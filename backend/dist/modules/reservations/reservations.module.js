...
exports.ReservationsModule = ReservationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([reservation_entity_1.Reservation, payment_entity_1.Payment]),
        ...
        providers: [reservations_service_1.ReservationsService, paymongo_service_1.PayMongoService],
