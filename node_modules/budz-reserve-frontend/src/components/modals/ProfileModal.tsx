    ...
    >
      ...
      >
        ...
        <div className="w-full sm:w-1/3 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 border-b sm:border-b-0 sm:border-r border-blue-200/30 flex flex-col relative flex-shrink-0">
          ...
          <div className="p-4 sm:p-5 md:p-6 text-center relative z-10">
            <div className="flex justify-center mb-4 sm:mb-6">
              <div className="relative inline-block group">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full p-0.5 sm:p-1 animate-pulse"></div>
                  <img
                    src={user?.profile_picture || '/assets/img/home-page/Ellipse 1.png'}
                    alt="Profile"
                    className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full object-cover border-2 sm:border-4 border-white shadow-2xl group-hover:shadow-3xl transition-all duration-500 group-hover:scale-105"
                  />
            ...
            <button
              ...
              className="text-white/90 text-xs sm:text-sm hover:text-white flex items-center justify-center mx-auto font-medium transition-all duration-300 mb-6 sm:mb-8 bg-white/20 hover:bg-white/30 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full backdrop-blur-sm"
            >
              <Upload className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
              <span className="hidden sm:inline">Edit profile picture</span>
            ...
            <div className="mb-6 sm:mb-8">
              <div className="flex items-center justify-center mb-2 sm:mb-3 flex-wrap gap-2">
                {user?.sex === 'Male' ? (
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-blue-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="text-white text-xs sm:text-sm font-bold">♂</span>
                  </div>
                ) : user?.sex === 'Female' ? (
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-pink-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="text-white text-xs sm:text-sm font-bold">♀</span>
                  </div>
                ) : (
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gray-400 rounded-full shadow-lg flex-shrink-0"></div>
                )}
                <span className="text-white font-bold text-lg sm:text-xl text-center">{user?.name || 'User'}</span>
              </div>
              <div className="text-xs sm:text-sm text-white/80 break-all bg-white/10 rounded-lg px-2 sm:px-3 py-1.5 sm:py-2 backdrop-blur-sm">
          ...
          <div className="flex-1 p-4 sm:p-6 relative z-10">
            <nav className="flex flex-wrap gap-2 sm:flex-col sm:gap-0 sm:space-y-4">
              <button
                onClick={() => setActiveTab('profile')}
                className={`flex-1 min-w-[calc(50%-0.5rem)] sm:min-w-0 sm:w-full flex items-center space-x-2 sm:space-x-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl transition-all duration-300 group relative overflow-hidden ${
                  activeTab === 'profile'
              ...
              >
                ...
                <div className={`relative z-10 p-1.5 sm:p-2 rounded-lg ${activeTab === 'profile' ? 'bg-white/20' : 'group-hover:bg-white/10'}`}>
                  <User className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <span className="font-semibold relative z-10 text-sm sm:text-base">Manage profile</span>
                {activeTab === 'profile' && (
                  <div className="ml-auto w-2 h-2 sm:w-3 sm:h-3 bg-white rounded-full shadow-lg relative z-10"></div>
                )}
              </button>
              ...
              >
                ...
                <div className={`relative z-10 p-1.5 sm:p-2 rounded-lg ${activeTab === 'password' ? 'bg-white/20' : 'group-hover:bg-white/10'}`}>
                  <Lock className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <span className="font-semibold relative z-10 text-sm sm:text-base">Change password</span>
                {activeTab === 'password' && (
                  <div className="ml-auto w-2 h-2 sm:w-3 sm:h-3 bg-white rounded-full shadow-lg relative z-10"></div>
                )}
              </button>
          ...
          <div className="p-4 sm:p-6 border-t border-white/20 relative z-10">
            <button
              onClick={handleLogout}
              className="w-full flex items-center justify-center space-x-2 sm:space-x-3 p-3 sm:p-4 rounded-xl sm:rounded-2xl text-white/90 hover:text-white transition-all duration-300 group bg-red-500/20 hover:bg-red-500/30 border border-red-400/30 hover:border-red-400/50 backdrop-blur-sm active:scale-95 touch-manipulation"
            >
              <div className="p-1.5 sm:p-2 rounded-lg bg-red-500/20 group-hover:bg-red-500/30 transition-colors duration-300">
