                ...
                {activeTab === 'history' && historyDates.length > 0 && (
                  <div className="relative" ref={dateDropdownRef}>
                    <button
                      ...
                      className="flex items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl border border-white/20 bg-white/20 px-3 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs text-white transition hover:bg-white/25 w-full sm:w-auto"
                    >
                      <span className="truncate">{selectedHistoryDate ? formatDateForDropdown(selectedHistoryDate) : 'Select date'}</span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        className={`h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform flex-shrink-0 ${isDateDropdownOpen ? 'rotate-180' : ''}`}
                      >
                        <path
                          fillRule="evenodd"
                    ...
                    {isDateDropdownOpen && (
                      <div className="absolute left-0 z-20 mt-2 w-full min-w-[180px] sm:min-w-[200px] overflow-hidden rounded-lg sm:rounded-xl border border-white/10 bg-[#11142b]/95 shadow-xl backdrop-blur-xl">
                        <div className="max-h-[250px] sm:max-h-[300px] overflow-y-auto divide-y divide-white/5">
                          {historyDates.map((date) => {
                            ...
                            return (
                              <button
                                ...
                                className={`flex w-full items-center justify-between px-3 sm:px-4 py-2 sm:py-3 text-left text-[10px] sm:text-xs font-medium transition ${
                                  isActive
                              ...
                              >
                                ...
                                {isActive && (
                                  <svg
                                    ...
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-blue-400 flex-shrink-0 ml-2"
                                  >
                                    <path
                                      fillRule="evenodd"
