...
@Index('idx_fee_management_player_id', ['playerId'])
@Index('idx_fee_management_user_id', ['userId'])
@Index('idx_fee_management_fee_date', ['feeDate'])
@Index('idx_fee_management_payment_status', ['paymentStatus'])
